...
class UserDataSetByUserIdResult(Enum):
...
class UserDataGetByUserIdResult(Enum):
	FAIL_BY_INVALID_PARAMETERS			= -5
	FAIL_BY_SERVICE_TEMPORARY_NOT_VALID	= -4
	FAIL_BY_ACCESS_DENIED				= -3
	FAIL_BY_TOKEN_EXPIRED				= -2
...
class UserDataKeysByUserIdGetResult(Enum):
	FAIL_BY_INVALID_PARAMETERS			= -5
	FAIL_BY_SERVICE_TEMPORARY_NOT_VALID	= -4
	FAIL_BY_ACCESS_DENIED				= -3
	FAIL_BY_TOKEN_EXPIRED				= -2
...
class UserDataKeysByUserIdDeleteResult(Enum):
	FAIL_BY_KEY_ACCESS_DENIED			= -6
	FAIL_BY_INVALID_PARAMETERS			= -5
	FAIL_BY_SERVICE_TEMPORARY_NOT_VALID	= -4
	FAIL_BY_ACCESS_DENIED				= -3
