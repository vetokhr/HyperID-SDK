...
//**************************************************************************************************
//	StorageByUserIdDataSet
//--------------------------------------------------------------------------------------------------
internal class StorageByUserIdDataSet(private val owner		: HyperIDSDKStorageByUserIdImpl,
									  val key				: String,
									  val value				: String,
									  val accessType		: UserDataAccessScope,
									  val completeListener	: IHyperIDSDKStorageByUserId.IDataSetResultListener) : RestApiRequest()
{
	override fun start()
	{
		owner.dataSet(this)
