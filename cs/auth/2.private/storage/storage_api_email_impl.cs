...
{
    internal class StorageApiEmailImpl : IStorageApiEmail
    {
        ...
        public StorageApiEmailImpl(IHyperIDSDKAuthRestApi restApi)
        {
            RestApi = restApi;
        }

        #region Data Set
        async Task<DataSetResult> IStorageApiEmail.DataSetAsync([NotNull] string key,
        ...
        #region Data Get
        async Task<DataGetResult> IStorageApiEmail.DataGetAsync(string key,
            CancellationToken cancellationToken)
        {
        ...
        #region Keys Get
        async Task<KeysGetResult> IStorageApiEmail.KeysGetAsync(CancellationToken cancellationToken)
        {
        ...
        async Task<KeysSharedGetResult> IStorageApiEmail.KeysGetSharedAsync(CancellationToken cancellationToken)
        {
            ...
            RestApiRequestKeysSharedGet request = new RestApiRequestKeysSharedGet(RestApi,
                "user-data/by-email/shared-list-get",
                content);
        ...
        #region Data Delete
        async Task<bool> IStorageApiEmail.DataDeleteAsync(List<string> keys, CancellationToken cancellationToken)
        {
